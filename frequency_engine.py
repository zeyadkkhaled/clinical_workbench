...
def inject_noise(image_array, noise_type):
    """Injects specific type of noise into the image."""
    # TODO (Ahmed): Implement noise injection and compute ROI mean/variance
    return None

def calculate_roi_statistics(image_array, roi_coords):
    """Calculates statistics for a specific Region of Interest."""
    # TODO (Ahmed): Implement noise injection and compute ROI mean/variance
    return None
